...
#include "hashpipe.h"
#include "gpu_output_paf_databuf.h"
#include "fitsio.h"
#include "fifo.h"
...
static hashpipe_thread_desc_t fake_gpu_paf_thread = {
    name: "fake_gpu_paf_thread",
    skey: "FGPUSTAT",
    init: init,
    run:  run,
    ibuf_desc: {NULL},
    obuf_desc: {gpu_output_paf_databuf_create}
};

static __attribute__((constructor)) void ctor()
{
  register_hashpipe_thread(&fake_gpu_paf_thread);
}
